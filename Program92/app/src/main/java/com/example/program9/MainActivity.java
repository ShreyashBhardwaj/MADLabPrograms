...
public class MainActivity extends AppCompatActivity implements SenderFragment.OnDataPass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.sender, new SenderFragment()).commit();

        receiverFragment = new ReceiverFragment();

        getSupportFragmentManager().beginTransaction().replace(R.id.receiver, receiverFragment).commit();
    }
